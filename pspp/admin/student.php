  ...
  <div id="main">
    <div class="container-fluid">
      <div class="container table-responsive">
        ...
        <h1 class="d-flex fw-bold"><ion-icon name="people"></ion-icon>&nbsp;Student Data</h1>
        <a href="newstudent.php" class="btn btn-outline-light fw-bold btn-sm mb-3" style="float:right;width:10%;border-radius:15px">New</a>
        <table class="table table-borderless table-hover table-responsive mt-4 text-center" style="border-radius: 20px;background:#fff;box-shadow: 0 5px 9px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <tbody>
                ...
                <td class="align-items-center">
                    ...
                    <a href="del-student.php?nisn=<?=$query['nisn'];?>" class="btn btn-danger mb-3 btn-sm text-white" style="border-radius:10px" onclick="return confirm('Are You Sure?')"><ion-icon name="trash-bin" class="text-center" style="font-size: 20px;"></ion-icon>&nbsp;</a>
                </td>
            </tr>
            </tbody>
                <?php endforeach ?>
