...
<head>
    ...
    <style>
      ...
      body{
        ...
        background-image: linear-gradient(to right, #AACB73, #AD7BE9);
      }
      .dropdown {
        position: relative;
        ...
        <div class="row">
            <div class="col">
              <div class="container table-responsive">
                ...
                <div class="card-body">
                <div class="card-title mt-3"><h4 style="font-family: 'DM Serif Display', serif;" class="fw-bold text-center">HISTORY</h4></div>
